...
private:
  ...
  bool find(BinaryNode* f, const string& x) const;

  void insert(BinaryNode*&i, const string& x);

  string pathTo(BinaryNode* p, const string& x) const;
