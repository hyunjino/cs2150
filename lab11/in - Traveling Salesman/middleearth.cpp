...
/**
 *@brief this shuffles a vector
 *
 *@return no return
 *@param first iterator pointing to first element of vector
 *@param last iterator pointing to last element of vector
 *@param g
...
/**
 *@brief creates a middle earth world
 *
 *@return its a constructor
 *@param xsize width of the world
 *@param ysize length of the world
 *@param num_cities number of cities in the world
 *@param seed seed for the world (like minecraft)
 *@todo write this doxygen comment
 */
...
/**
 *@brief prints out about the world
 *
 *@return no return
 *@todo write this doxygen comment
 */
...
/**
 *@brief prints a table of the cities
 *
 *@return no return
 *@todo write this doxygen comment
 */
...
/**
 *@brief finds distance between two cities
 *
 *@return float distance
 *@param city1 first city to find the distance from
 *@param city2 second city to find the distance to
 *@todo write this doxygen comment
 */
...
/**
 *@brief gets the order of cities to visit
 *
 *@return a vector of cities
 *@param length length of itinerary
 *@todo write this doxygen comment
 */
